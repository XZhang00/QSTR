...
class ParaScorer:
    ...
    def free_score(self, cands, sources, thres=0.35, verbose=False, batch_size=1024, return_hash=False):
    ...
    def base_score(self, cands, sources, refs, thres=0.15, verbose=False, batch_size=64, return_hash=False):
        diversity = diverse(cands, sources)
